...
Tiếp tục `Phase 4: Search And Retrieval`: bắt đầu tích hợp embedding provider abstraction hoạt động được trên Apple Silicon.
...
- index/reindex hiện vẫn dùng placeholder vector ở Phase 3; bước kế tiếp là semantic embedding provider thật ở Phase 4
